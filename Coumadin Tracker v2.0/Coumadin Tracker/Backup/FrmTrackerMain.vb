...
Public Class FrmTrackerMain
    ...
    Private Sub FrmTrackerMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim tblResults As DataTable = dsResults.Tables("tblResultView")   'this needs completed
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click, btnMyInterval1.Click
