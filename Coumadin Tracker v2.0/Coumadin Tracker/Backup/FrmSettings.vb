    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If IntCount = 0 Then
            SelectString = "INSERT INTO tblSettings([EnterpriseSetting], [PTCode], [INRCode], [DefaultOverdueInterval], " & _
                "[OverdueIntervalAllowOverride], [DefaultNotify], [NotifyAllowOverride], [DefaultTaskPriority], [TaskPriorityAllowOverride], [Email]) " & _
                "VALUES (1, '" & Me.txtPTCode.Text & "', '" & Me.txtINRCode.Text & "', " & Me.NumDefaultOverdueInterval.Value & ", " & _
                Me.ChkAllow1.CheckState & ", " & Me.ChkDefaultNotify.CheckState & ", " & Me.ChkAllow2.CheckState & ", '" & Me.cmbTaskPriority.Text & "', " & Me.ChkAllow3.CheckState & ", '" & Me.txtEmail.Text & "');"
        ...
        ElseIf IntCount = 1 Then
            SelectString = "UPDATE tblSettings SET [EnterpriseSetting] = 1, [PTCode] = '" & Me.txtPTCode.Text & "', [INRCode] = '" & Me.txtINRCode.Text & _
                ...
                Me.cmbTaskPriority.Text & "', [TaskPriorityAllowOverride] = " & Me.ChkAllow3.CheckState & ", [Email] = '" & Me.txtEmail.Text & "' WHERE [EnterpriseSetting] = 1;"
