    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If IntCount = 0 Then
            SelectString = "INSERT INTO tblSettings([EnterpriseSetting], [DefaultOverdueInterval], " & _
                "[DefaultNotify], [DefaultTaskPriority], [Email], [UserID], [MyInterval1], [MyInterval2]) " & _
                "VALUES (0, " & Me.NumDefaultOverdueInterval.Value & ", " & Me.ChkDefaultNotify.CheckState & ", '" & _
                Me.cmbTaskPriority.Text & "', '" & Me.txtEmail.Text & "', " & UserID & ", " & Me.NumMyInterval1.Value & ", " & Me.NumMyInterval2.Value & ");"
        ...
        ElseIf IntCount = 1 Then
            SelectString = "UPDATE tblSettings SET [EnterpriseSetting] = 0, " & _
                ...
                Me.cmbTaskPriority.Text & "', [Email] = '" & Me.txtEmail.Text & "', [MyInterval1] = " & _
